...
The purpose of this project is to battle-test [axolotl](https://github.com/gold-meridian/axolotl) and to develop a practical project with it to ensure it covers the bases for a GUI app.
